...
const Workflow = () => {
  return (
    <div className='flex flex-col items.center text-center mb-8 justify-center gap-4 space-y-28 mt-20 mx-6'>
      ...
      <div className='flex items-center flex-col '>  
        <img src={list} alt="" />
        <h2 className='text-3xl font-bold my-3 text-DarkGrayishBlue'>Create blackists</h2>
      ...
      <div className='flex items-center flex-col '>  
        <img src={text} alt="" />
        <h2 className='text-3xl font-bold my-3 text-DarkGrayishBlue'>Plain text snippets</h2>
        <p className='text-gray-500 md:max-w-sm'>remove unwanted formatting from copied text for a consistant look.</p>
      </div>
      <div className='flex items-center flex-col '>  
        <img src={preview} alt="" />
        <h2 className='text-3xl font-bold my-3 text-DarkGrayishBlue'>sneak preview</h2>
