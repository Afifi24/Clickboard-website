  ...
  return (
    <div className='flex flex-col items.center text-center mb-8 justify-center gap-4 space-y-28 mt-20 mx-6'>
      <div className='flex items-center flex-col '>
        <h2 className='text-3xl font-bold my-3'>Supercharge your workflow</h2>
        <p className='text-gray-500 md:max-w-sm'>We have got the tools to boost your productivity.</p>
      </div>
      <div className='space-y-12 md:space-y-0 md:grid md:grid-cols-3 md:space-x-2 md:place-items-center md:mx-10 mb-10'>
      <div className='flex items-center flex-col '>  
        <img src={list} alt="" />
        <h2 className='text-3xl font-bold my-3'>Create blackists</h2>
        <p className='text-gray-500 md:max-w-sm'>ensure sensitive information never makes its way to your clipboard by excluding certain sources.</p>
      </div>
      <div className='flex items-center flex-col '>  
        <img src={text} alt="" />
        <h2 className='text-3xl font-bold my-3'>Plain text snippets</h2>
        <p className='text-gray-500 md:max-w-sm'>remove unwanted formatting from copied text for a consistant look.</p>
      </div>
      <div className='flex items-center flex-col '>  
        <img src={preview} alt="" />
        <h2 className='text-3xl font-bold my-3 '>sneak preview</h2>
        <p className='text-gray-500 md:max-w-sm'>quick preview of all snippets on your clipboard for easy access.</p>
      </div>
      </div>
