  ...
  return (
    <div className='flex items-center justify-center text-center mt-14'>
      <div className=''> 
        ...
        <h2 className='text-3xl font-bold mx-10 text-DarkGrayishBlue'>Keep track of your snippets</h2>
        ...
        <div className='my-8 mt-16 space-y-4 md:flex md:items-center gap-20 mx-6 md:mr-6'>
            ...
            <div className='space-y-8 mt-10 md:mt-0'>
                <div className=''>
                    <h2 className='font-bold text-3xl mb-4 md:text-left text-DarkGrayishBlue'>Quick Search </h2>
                ...
                <div>
                    <h2 className='font-bold text-3xl mb-4 md:text-left text-DarkGrayishBlue'>iCloud Sync  </h2>
                    <p className='text-gray-600 md:max-w-sm md:text-left'>Instantly saves and syncs snippets across all your devices.</p>
                </div>
                <div>
                    <h2 className='font-bold text-3xl mb-4 md:text-left text-DarkGrayishBlue'>Complete History </h2>
